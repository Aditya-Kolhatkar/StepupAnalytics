...
### length of vector v = 31
### length of vector w = 11
### difference between the length of vector v and w  = 31-11 = 20
```
...
```{r}
MEAN<-mean(v_square[c(1:5)])
MEAN
MDN<-median(v_square[c(1:5)])
MDN
...
```{r}
t=table( beaver1[ beaver1$activ == 1 , c("day") ] )
t
```
